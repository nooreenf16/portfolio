...
export default function Home() {
  return (
    <div style={{ height: '800px', position: 'relative' }}>
      ...
      <div className="relative h-[510px] w-full overflow-hidden demo-container">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white pointer-events-auto">
          <h1 className="text-4xl font-bold mb-4">Nooreen Fatima</h1>
      ...
      <div className="relative mt-10 mb-10 flex flex-row justify-around">
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-5 w-80 text-center text-white shadow-lg">
